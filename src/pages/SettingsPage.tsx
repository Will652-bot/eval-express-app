...
export const SettingsPage: React.FC = () => {
  ...
  const checkDemoDataStatus = async () => {
    ...
    try {
      ...
      // Utiliser la nouvelle fonction RPC has_demo_data
  ...
  // Fonction pour forcer la revalidation après les RPCs
  ...
  const handleCreateDemoData = async () => {
    ...
    setDemoLoading(true);
    try {
      // Vérification préalable avec has_demo_data
      ...
      // Appeler la fonction RPC pour créer les données de démonstration
      ...
      // Forcer la revalidation du statut
      await refetchDemoStatus();
      
      // Clear the banner dismissal flag so it can show again if needed
  ...
  const handleDeleteDemoData = async () => {
    ...
    setDemoLoading(true);
    try {
      // Vérification préalable avec has_demo_data_to_delete
      ...
      // Appeler la fonction RPC pour supprimer les données de démonstration
      ...
      if (error) {
        // Check if error is due to no demo data found
        if (error.message?.includes('No demo data found for this user')) {
          ...
          // Forcer la revalidation même en cas d'erreur
          await refetchDemoStatus();
        } else {
          throw error;
        }
  ...
  // Get status message based on demo data state
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1 relative group">
                <Button
                  ...
                  className="w-full"
                  disabled={hasDemoData === true || demoLoading || checkingDemoStatus}
                  variant={hasDemoData !== true && !checkingDemoStatus ? "primary" : "outline"}
                >
            ...
            <div className="flex justify-center">
              <Button
                variant="ghost"
                size="sm"
                onClick={refetchDemoStatus}
                isLoading={checkingDemoStatus}
      ...
      {/* Confirm Modal for Demo Data Deletion */}
      <ConfirmModal
