...
import { Menu, X, ChevronDown, GraduationCap, LogOut, Users, BookOpen, FileCheck, ListChecks, BarChart, Palette, CreditCard, Info, Settings, FileText, ClipboardList, Link as LinkIcon } from 'lucide-react';
          ...
          <div className="flex">
            ...
            <div className="flex-shrink-0 flex items-center">
              <Link to="/dashboard" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900">EvalExpress</span>
              </Link>
            </div>
