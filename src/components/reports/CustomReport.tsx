...
export const CustomReport: React.FC = () => {
  ...
  }, [selectedClasses, selectedStudents, selectedCriteria, startDate, endDate, selectedTitleIds, students, criteria, evaluationTitles]);
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  <th 
                    className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer sticky left-0 bg-gray-50"
                  ...
                  <th 
                    className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer sticky right-0 bg-gray-50"
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {loading ? (
                  <tr>
                    <td colSpan={visibleCriteria.length + 2} className="px-6 py-4 text-center">
                  ...
                  <tr>
                    <td colSpan={visibleCriteria.length + 2} className="px-6 py-4 text-center text-gray-500">
                  ...
                  getSortedData().map(row => {
                    ...
                    return (
                      <tr key={row.studentName}>
                        ...
                        <td 
                          className="px-6 py-4 whitespace-nowrap text-sm font-bold sticky right-0 bg-white"
